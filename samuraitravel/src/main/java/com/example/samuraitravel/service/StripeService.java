...
import com.example.samuraitravel.module.mFileReader;
...
public class StripeService {
    ...
    // メソッド概要：Stripeに送信する支払い情報をセッションとして作成する
    ...
    public void processSessionCompleted(Event event) {
        ...
        // StripeのAPIとstripe-javaライブラリのバージョンの組み合わせによっては互換性がない為、原因を特定しやすくする
